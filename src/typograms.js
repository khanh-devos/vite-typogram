...
glyphs['-'] = ([top, right, bottom, left, topRight, bottomRight, bottomLeft, topLeft]) => cross([
  ['|'].includes(top), // top
  true, // right
...
for (const [key, value] of Object.entries(alias)) {
  glyphs[key] = (around) => glyphs[value](around);
}
